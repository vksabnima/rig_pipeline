...
CAS precision, and Llama-3-8B template-uniformity inflation in OAL,
CAS, and HRR-Stability).
...
systematically overstate smaller-model quality via template-following
inflation unless cross-checked against independent gold-validated
RIF.
