...
annotator content-drift relative to the pilot. Per-field $\kappa$
...
non-overlapping CIs), with Qwen3-235B (0.543 [0.531, 0.556]) and
Llama-3-8B (0.549 [0.538, 0.561]) landing between the two closed
models with no significant ordering among the open-model pair.
